...
Understand and structure the initial idea and its context.

The consultant explores:

- the problem or situation behind the idea
...
The purpose of this stage is to establish how the product works at a high level before detailed requirements are defined.
...
The consultant defines the expected product behavior, including:
...
- alternative and error behavior
- functional interactions
- external system requirements
- relevant non-functional requirements

The purpose of this stage is to describe **what the product must do** in sufficient detail for technical solution design.

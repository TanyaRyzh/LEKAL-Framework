...
At the beginning of the process, the client typically presents a raw idea.  
However, the idea alone is rarely sufficient to begin product design. The consultant must first understand the surrounding context, constraints, expectations, and assumptions.

Idea Clarification focuses on extracting this information.

---

# Objective

Collect enough information about the idea, context, and expectations to allow the product development phase to begin.

---

# Input

The stage starts with a raw idea expressed by the client.

This idea may be incomplete, vague, or highly abstract.
...
- a short concept of a system

---

# Focus Areas

During this stage the consultant aims to understand several aspects surrounding the idea.

### Problem context

What situation or problem led to the idea?

### Users and stakeholders

Who is expected to use the product or benefit from it?

### Expected outcomes

What results does the client expect from the product?

### Constraints

Are there known limitations such as time, budget, technology, or integration requirements?
